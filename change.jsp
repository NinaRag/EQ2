...
<link rel="stylesheet" type="text/css" href="student1.css?v=2">
...
<h1 style="font-size:240%;"><a href="mentordash.jsp" style="text-decoration: none;color: #2A2965">Back To Dashboard</a></h1></div></div>
  ...
  <option value="MIT">MIT</option></select></div>
	...
	<form  class="signIn" action="./change" onsubmit="passCheck();return false;" method="post" autocomplete="off">
		...
		<div id="message" name="message" style="color:red;" ><%! String flag="false"; %> <% String flag = (String) request.getAttribute("flag"); %> 
		<% if(flag=="true"){out.print(request.getAttribute("messag"));} %></div> 
		
		<!-- <button class="form-btn sx back" type="button">Sign Up</button> -->
		<div align="center";><button class="form-btn dx" type="submit">Change</button></div>
	</form>
