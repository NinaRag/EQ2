...
<link rel="stylesheet" type="text/css" href="student.css?v=2">
...
<h1 style="font-size:240%;"><a href="index.jsp" style="text-decoration: none;color: #2A2965">EQ CLUB</a></h1></div></div>
  ...
  <option value="MIT">MIT</option></select></div>
	...
	<form  class="signIn" action="./studentLog" method="post" autocomplete="off">
...
<% if(stat6=="true" && stat!="true"){ %> $(".signIn").addClass("active-dx");
	$(".signUp").addClass("inactive-sx");
	$(".signUp").removeClass("active-sx");
	$(".signIn").removeClass("inactive-dx");
